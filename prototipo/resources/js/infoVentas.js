    ...
    try {
      ...
      new Tabulator('#info-ventas', {
        ...
        columns: [
          ...
          { title: 'TOTAL', field: 'venta.total', hozAlign: 'center', formatter: 'money' }
        ],
          ...
          if (row.getData().detalle) {
            var subTable = new Tabulator(tableEl, {
              ...
              columns: [
                ...
                { title: 'Valor', field: 'producto.valorVenta', hozAlign: 'center', formatter: 'money' },
                { title: 'Subtotal', field: 'subtotal', hozAlign: 'center', formatter: 'money' }
              ]
            })
          } else {
