...
export default class Alert extends Popup {
  constructor({
    ...
    image = '',
    button = { caption: 'Aceptar', classes: ['h-10 text-white font-[bold] cursor-pointer transition-all duration-[0.3s] ease-[ease] relative inline-block shadow-[inset_2px_2px_2px_0px_rgba(255,255,255,0.5),7px_7px_20px_0px_rgba(0,0,0,0.1),4px_4px_5px_0px_rgba(0,0,0,0.1)] px-[15px] py-0 rounded-[5px] font-sans bg-transparent outline-none', 'btn-cancel'], action: () => this.remove() }
  } = {}) {
